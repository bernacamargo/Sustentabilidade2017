...
require_once('Authentication/AccessToken.php');
require_once('Authentication/OAuth2Client.php');
require_once('FileUpload/FacebookFile.php');
require_once('FileUpload/FacebookResumableUploader.php');
require_once('FileUpload/FacebookTransferChunk.php');
require_once('FileUpload/FacebookVideo.php');
require_once('GraphNodes/GraphEdge.php');
require_once('Url/UrlDetectionInterface.php');
require_once('Url/FacebookUrlDetectionHandler.php');
require_once('PseudoRandomString/PseudoRandomStringGeneratorFactory.php');
require_once('PseudoRandomString/PseudoRandomStringGeneratorInterface.php');
require_once('HttpClients/HttpClientsFactory.php');
require_once('PersistentData/PersistentDataFactory.php');
require_once('PersistentData/PersistentDataInterface.php');
require_once('Helpers/FacebookCanvasHelper.php');
require_once('Helpers/FacebookJavaScriptHelper.php');
require_once('Helpers/FacebookPageTabHelper.php');
require_once('Helpers/FacebookRedirectLoginHelper.php');
require_once('Exceptions/FacebookSDKException.php');
