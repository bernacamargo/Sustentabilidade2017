...
<div class="row" style="padding-top: 30px;">
    <div class="col-md-2">
        <a href="<?php echo site_url('profissionais/ver/'.$interessado['CodUsuario'].'') ?>" title="Clique aqui para ver o perfil profissional do <?php echo $interessado['Nome'] ?>">
...
<br>
    ...
    <div class="col-md-5 text-right">
        <button type="button" class="btn btn-primary" onclick="location.href='<?php echo site_url('conversas/conversa/'.$interessado['CodUsuario']); ?>'"><i class="fa fa-comments-o"></i> Enviar Mensagem</button>
